...
#### copy cmdline.txt config.txt (berryboot config files)
sudo cp sources/sbin/cmdlinePi4.txt /sbin/cmdline.txt
sudo chmod 755 /sbin/cmdline.txt
sudo cp sources/sbin/configPi4.txt /sbin/config.txt
sudo chmod 755 /sbin/config.txt
#sudo cp sources/sbin/config_USBWifiPi4.txt /sbin/config_USBWifi.txt
#sudo chmod 755 /sbin/config_USBWifi.txt
#sudo cp sources/sbin/config_InternalWifiPi4.txt /sbin/config_InternalWifi.txt
#sudo chmod 755 /sbin/config_InternalWifi.txt
